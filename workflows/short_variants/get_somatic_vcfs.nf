include { smurf } from '../../NextflowModules/SMuRF/3.0.2/SMuRF.nf' params(params)
...
workflow get_somatic_vcfs {
  ...
  main:
    ...
    ch_filtered_vcf = smurf.out.smurf_filtered_vcf
	.map{ donor_id, smurf_filtered_vcf ->
