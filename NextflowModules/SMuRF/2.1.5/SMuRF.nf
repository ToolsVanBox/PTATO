process smurf {
  ...
  script:
    ...
    . /hpc/pmc_vanboxtel/tools/ToolsVanBox/SMuRF-2.1.5/venv_3.6/bin/activate

    python /hpc/pmc_vanboxtel/tools/ToolsVanBox/SMuRF-2.1.5/SMuRF.py \
    -i ${germline_vcf} \
    ${b} \
    ${n} \
    -t ${task.cpus} \
    ...
    bash /hpc/pmc_vanboxtel/tools/ToolsVanBox/SMuRF-2.1.5/scripts/split_in_single_sample_vcfs.sh ${germline_sample_id}.SMuRF.filtered.vcf
